    ...
    local st, err = pcall(function()
        ...
        while true do
            ...
            if leadingWhite ~= "" then
                ...
                token.Print = function()
                    return "<" ..
                               (token.Type .. string.rep(' ', 7 - #token.Type)) ..
                               "  " .. (token.Data or '') .. " >"
                end
                table.insert(leading, token)
            end
...
local function ParseLua(src)
    ...
    local ParseSimpleExpr, ParseSubExpr, ParsePrimaryExpr, ParseSuffixedExpr
    ...
    function ParseSimpleExpr(scope)
        ...
        elseif tok:ConsumeSymbol('{', tokenList) then
            ...
            while true do
                ...
                if tok:ConsumeSymbol(';', tokenList) or
        ...
        elseif tok:ConsumeKeyword('for', tokenList) then
            ...
            if tok:ConsumeSymbol('=', tokenList) then
                ...
                while tok:ConsumeSymbol(',', tokenList) do
                    ...
                    varList[#varList + 1] =
                        forScope:CreateLocal(tok:Get(tokenList).Data)
                end
