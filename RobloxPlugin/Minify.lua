...
function lookupify(tb)
    for _, v in pairs(tb) do tb[v] = true end
    return tb
end
...
function PrintTable(tb, atIndent)
    if tb.Print then return tb.Print() end
    ...
    for k, v in pairs(tb) do
        if type(v) ~= 'function' then
            ...
            if next(tb, k) then out = out .. "," end
            if useNewlines then out = out .. '\n' end
        end
    end
            ...
            if peek() == '[' then
                ...
                if peek(equalsCount + 1) == '[' then
                    ...
                    while true do
                        ...
                        if peek() == '' then
                            generateError(
                                "Expected `]" .. string.rep('=', equalsCount) ..
                                    "]` near <eof>.", 3)
                        end
        ...
        while true do
            ...
            elseif UpperChars[c] or LowerChars[c] or c == '_' then
                ...
                repeat
                    get()
                    c = peek()
                until not (UpperChars[c] or LowerChars[c] or Digits[c] or c ==
                    '_')
            ...
            toEmit.Print = function()
                return
                    "<" .. (toEmit.Type .. string.rep(' ', 7 - #toEmit.Type)) ..
                        "  " .. (toEmit.Data or '') .. " >"
            end
...
function ParseLua(src)
    ...
    local function GenerateError(msg)
        local err =
            ">> :" .. tok:Peek().Line .. ":" .. tok:Peek().Char .. ": " .. msg ..
                "\n"
        -- find the line
        local lineNum = 0
    ...
    local function CreateScope(parent)
        ...
        function scope:RenameVars()
            for _, var in pairs(scope.LocalList) do
                ...
                until not GlobalVarGetMap[id] and not parent:GetLocal(id) and
                    not scope.LocalMap[id]
                var.Name = id
    ...
    local function ParsePrimaryExpr(scope)
        ...
        elseif tok:Is('Ident') then
            ...
            if not var then GlobalVarGetMap[id.Data] = true end
            --
            local nodePrimExp = {}
            ...
            while true do
                ...
                elseif tok:Is('Ident') then
                    ...
                    if lookahead.Type == 'Symbol' and lookahead.Data == '=' then
                        ...
                        v.EntryList[#v.EntryList + 1] =
                            {Type = 'KeyString', Key = key.Data, Value = value}
        ...
        elseif tok:IsKeyword('goto') then
            ...
            if tok:IsSymbol(',') or tok:IsSymbol('=') then
                ...
                if (suffixed.ParenCount or 0) > 0 then
                    return false, GenerateError(
                               "Can not assign to parenthesized expression, is not an lvalue")
                end
            ...
            elseif suffixed.AstType == 'CallExpr' or suffixed.AstType ==
                'TableCallExpr' or suffixed.AstType == 'StringCallExpr' then
    ...
    formatExpr = function(expr)
        ...
        elseif expr.AstType == 'CallExpr' then
            ...
            for i = 1, #expr.Arguments do
                ...
                if i ~= #expr.Arguments then out = out .. "," end
            end
            out = out .. ")"
        ...
        elseif expr.AstType == 'IndexExpr' then
            out =
                out .. formatExpr(expr.Base) .. "[" .. formatExpr(expr.Index) ..
                    "]"

        elseif expr.AstType == 'MemberExpr' then
            out = out .. formatExpr(expr.Base) .. expr.Indexer ..
                      expr.Ident.Data
        ...
        elseif expr.AstType == 'ConstructorExpr' then
            ...
            for i = 1, #expr.EntryList do
                ...
                if i ~= #expr.EntryList then out = out .. "," end
            end
            out = out .. "}"
    ...
    local formatStatement = function(statement)
        ...
        if statement.AstType == 'AssignmentStatement' then
            for i = 1, #statement.Lhs do
                ...
                if i ~= #statement.Lhs then out = out .. "," end
            end
        ...
        elseif statement.AstType == 'ReturnStatement' then
            ...
            for i = 1, #statement.Arguments do
                out =
                    joinStatementsSafe(out, formatExpr(statement.Arguments[i]))
        ...
        elseif statement.AstType == 'Function' then
            ...
            if statement.IsLocal then out = "local" end
        ...
        elseif statement.AstType == 'NumericForStatement' then
            ...
            out = out .. formatExpr(statement.Start) .. "," ..
